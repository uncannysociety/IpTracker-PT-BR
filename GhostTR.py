...
╚██████╔╝██║  ██║╚██████╔╝███████║   ██║███████╗███████║███████╗╚██████╗
 ╚═════╝ ╚═╝  ╚═╝ ╚═════╝ ╚══════╝   ╚═╝╚══════╝╚══════╝╚══════╝ ╚═════╝
    ...
    {Wh}[ 1 ] {Gr}Rastreador IP
    {Wh}[ 2 ] {Gr}Mostrar seu IP
    {Wh}[ 3 ] {Gr}Rastreador de telefone
    {Wh}[ 4 ] {Gr}Rastreador de nome de usuário
    {Wh}[ 0 ] {Gr}Sair
""")
...
if input_user == '1': #OPSI 1
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}--------------------------------
   :g g   :         {Wh}|{Gr}GHOST - TRACKER - ENDEREÇO IP {Wh}|
...
:   :          ` . `.
 `.. :            `. ``;
    ...
    try:
        def IP_Track():
            ip = input(f"{Wh}\n Coloque o IP da vítima : {Gr}") #INPUT IP ADDRESS
            print()
            print(f' {Wh}============= {Gr}MOSTRAR INFORMAÇÕES ENDEREÇO IP {Wh}=============')
        ...
        print(f" {Wh}[{Ye}!{Wh}] {Ye}Programa Encerrado...")
...
:   :          ` . `.
 `.. :            `. ``;
    ...
    try:
        def phoneGW():
            User_phone = input(f"\n {Wh}Coloque o número da vítima {Gr}Ex [+5511xxxxxxxxx] {Wh}: {Gr}") #INPUT NUMBER PHONE
            ...
            print(f"\n {Wh}========== {Gr}MOSTRAR INFORMAÇÕES NÚMEROS DE TELEFONE {Wh}==========")
...
""")
    ...
    try:
        def showIP():
            ...
            print(f"\n {Wh}========== {Gr}MOSTRE INFORMAÇÕES AO SEU IP {Wh}==========")
            print(f"\n {Wh}[{Gr} + {Wh}] Seu endereço IP : {Gr}{Show_IP}")
            print(f"\n {Wh}==============================================")
        if __name__ == '__main__':
            showIP()
    except KeyboardInterrupt:
...
""")
        ...
        def TrackLu(username):
            ...
            for site in social_media:
                ...
                if response.status_code == 200:
                    ...
                    results[site['name']] = (f"{Ye}Nome de usuário não encontrado {Ye}!")
            return results
        username = input(f"\n {Wh}Enter Username : {Gr}")
        print(f"\n {Wh}========== {Gr}MOSTRAR INFORMAÇÕES DE USUÁRIO {Wh}==========")
        print()
    ...
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}Obrigado por usar essa Ferramenta {Ye}GHOST-TRACK !")
else:
